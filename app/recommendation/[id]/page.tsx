  ...
  if (loading) {
    return (
      <div style={{ maxWidth: 768, margin: "0 auto", padding: "2.5rem 1.5rem" }}>
        <div style={{ height: "1rem", width: "5rem", marginBottom: "1.5rem", borderRadius: "100px", background: "var(--border)" }} className="skeleton" />
        <DetailSkeleton />
      </div>
    );
  }
  ...
  return (
    <div style={{ maxWidth: 768, margin: "0 auto", padding: "2.5rem 1.5rem" }}>
      ...
      <article className="card" style={{ padding: "2rem", marginBottom: "1.5rem" }}>
        ...
        {/* Upvote */}
        <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: "1.5rem", display: "flex", alignItems: "center", gap: "1rem" }}>
          {user ? (
            <button
      ...
      <section className="card" style={{ padding: "1.75rem" }}>
        ...
        {user ? (
          ...
          >
            ...
            <Link href="/login" className="btn btn-purple" style={{ padding: "0.5rem 1.25rem", fontSize: "0.85rem" }}>
              Login
            </Link>
          </div>
        )}
